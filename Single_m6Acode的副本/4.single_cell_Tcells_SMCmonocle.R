...
###
selcet_sce<-sce[,sce$Cell_subtype %in% "CD8+ T cells"]
...
ggsave("monocle_majorCluster_State_TcellSMC_CD8.pdf", width = 5, height = 5)
ggsave("monocle_majorCluster_State_TcellSMC_NK.pdf", width = 5, height = 5)
ggsave("monocle_majorCluster_State_TcellSMC_Treg.pdf", width = 5, height = 5)
ggsave("monocle_majorCluster_State_TcellSMC_CD4.pdf", width = 5, height = 5)
#pdf(file="05.trajectory.Pseudotime.pdf",width=6.5,height=6)
plot_cell_trajectory(cds,color_by = "Pseudotime")
ggsave("monocle_majorCluster_Pseudotime_CD8_SMC.pdf", width = 5, height = 5)
ggsave("monocle_majorCluster_Pseudotime_NK_SMC.pdf", width = 5, height = 5)
ggsave("monocle_majorCluster_Pseudotime_Treg_SMC.pdf", width = 5, height = 5)
ggsave("monocle_majorCluster_Pseudotime_Treg_CD4.pdf", width = 5, height = 5)
#dev.off()
...
ggsave("monocle_majorCluster_NMFclusterTcellSMC.pdf", width = 5, height = 5)
plot_cell_trajectory(cds, color_by = "Cell_subtype",cell_size = 0.8)+  scale_color_manual(values = mycol)
ggsave("monocle_majorCluster_Cell_subtypeTcellSMC.pdf", width = 5, height = 5)
...
#
pdf("T_CD8_cell_pseudotime_Heatmap_m6a.pdf",width = 4.47,height=5.53)
pdf("T_NK_cell_pseudotime_Heatmap_m6a.pdf",width = 4.47,height=5.53)
pdf("Treg_cell_pseudotime_Heatmap_m6a.pdf",width = 4.47,height=5.53)
pdf("T_CD4_cell_pseudotime_Heatmap_m6a.pdf",width = 4.47,height=5.53)
