...
ggsave("monocle_majorCluster_State_TcellSMC_Fibroblast.pdf", width = 5, height = 5)

#pdf(file="05.trajectory.Pseudotime.pdf",width=6.5,height=6)
plot_cell_trajectory(cds,color_by = "Pseudotime")
ggsave("monocle_majorCluster_Pseudotime_Fibroblast.pdf", width = 5, height = 5)
...
#dev.off()
ggsave("monocle_majorCluster_Fibroblast.pdf", width = 5, height = 5)
###
...
#
pdf("Fibroblast_pseudotime_Heatmap_m6a.pdf",width = 4.47,height=5.53)
